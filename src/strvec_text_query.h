#ifndef STRVEC_TEXT_QUERY_H
#define STRVEC_TEXT_QUERY_H
...
private:
    /* data */
    shared_ptr<StrVec> v_file;
    map<string, shared_ptr<set<line_number>>> m_word;
};

inline TextQueryEp::TextQueryEp(ifstream &inf) : v_file(new StrVec) {
    string text;
