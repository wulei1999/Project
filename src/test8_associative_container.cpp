...
unordered_map<string, string> trans_map(ifstream &inf) {
    string word;
    string value;
    unordered_map<string, string> tansform_map;
...
const string &transformWord(const string &str, const unordered_map<string, string> &m) {
...
void transform_file(ifstream &rule_file, ifstream &input_file) {
    unordered_map<string, string> t_map = trans_map(rule_file);
    string text;
