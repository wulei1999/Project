#ifndef QUERY_RESULT_EP_H
#define QUERY_RESULT_EP_H

#include "text_query_ep.h"
using std::ostream;
class QueryResultEp {
...
private:
    ...
    shared_ptr<vector<string>> v_sptr;
};
